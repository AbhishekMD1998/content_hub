...
echo ""
echo "Next steps:"
echo "  1. docker compose down     (stop local Docker DB)"
echo "  2. bash scripts/start-backend.sh   (Flyway creates tables + seeds data)"
echo "  3. npm run dev"
echo ""
echo "Optional: run supabase/schema.sql in SQL Editor first — Flyway will baseline automatically."
